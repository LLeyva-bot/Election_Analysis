...
#Cadidtate options and candidate votes
candidate_options = []
...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        #Retrieve candidate's name, vote count, and percentage of votes to the terminal. 
        ...
        if (votes > winning_count) and (vote_percentage > winning_percentage):
            #if ture then set winning_count = votes and winning_percent = vote_percentage
            winning_count = votes
            winning_percentage = vote_percentage
            #And, set the winning_candidate equal to the candidate's name.vote_percentage. 
